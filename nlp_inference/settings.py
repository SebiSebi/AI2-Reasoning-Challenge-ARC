...
TRAIN_DATA_PATH = os.path.join("data", "snli_1.0_train.jsonl")
VALIDATE_DATA_PATH = os.path.join("data", "snli_1.0_dev.jsonl")
TEST_DATA_PATH = os.path.join("data", "snli_1.0_test.jsonl")
