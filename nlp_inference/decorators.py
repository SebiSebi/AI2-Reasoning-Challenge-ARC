...
from nlp_inference.settings import USE_SNLI_CACHE, CACHING_DIR
        ...
        def wrapper(*args, **kwargs):
            ...
            if USE_SNLI_CACHE:
                ...
                if os.path.isfile(file_path):
                    print("[SNLI-Cache] Using cached result.")
            ...
            if USE_SNLI_CACHE and is_new:
                # Save res in cache using h.
                file_path = os.path.join(CACHING_DIR, prefix_name, h + ".bin")
                with open(file_path, "wb") as g:
                    g.write(pickle.dumps(res))
                    g.flush()
                print("[SNLI-Cache] Result has been cached.")
