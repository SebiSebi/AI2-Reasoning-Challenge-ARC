...
from multinli.settings import USE_MULTINLI_CACHE, CACHING_DIR
        ...
        def wrapper(*args, **kwargs):
            ...
            if USE_MULTINLI_CACHE:
                ...
                if os.path.isfile(file_path):
                    print("[MultiNLI-Cache] Using cached result.")
            ...
            if USE_MULTINLI_CACHE and is_new:
                # Save res in cache using h.
                file_path = os.path.join(CACHING_DIR, prefix_name, h + ".bin")
                with open(file_path, "wb") as g:
                    g.write(pickle.dumps(res))
                    g.flush()
                print("[MultiNLI-Cache] Result has been cached.")
