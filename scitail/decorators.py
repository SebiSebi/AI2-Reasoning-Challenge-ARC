...
from scitail.settings import USE_SCITAIL_CACHE, CACHING_DIR
        ...
        def wrapper(*args, **kwargs):
            ...
            if USE_SCITAIL_CACHE:
                ...
                if os.path.isfile(file_path):
                    print("[SciTail-Cache] Using cached result.")
            ...
            if USE_SCITAIL_CACHE and is_new:
                # Save res in cache using h.
                file_path = os.path.join(CACHING_DIR, prefix_name, h + ".bin")
                with open(file_path, "wb") as g:
                    g.write(pickle.dumps(res))
                    g.flush()
                print("[SciTail-Cache] Result has been cached.")
