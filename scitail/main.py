...
from scitail.arch import define_model
from scitail.utils import read_data_as_json, print_data_stats
from scitail.utils import remove_unlabeled_data, all_sentences
from scitail.utils import pick_best_model_from_dir
from scitail.settings import TRAIN_DATA_PATH
from scitail.settings import VALIDATE_DATA_PATH
from scitail.settings import TEST_DATA_PATH
from scitail.settings import DEBUG, PREMISE_LEN, HYPOTHESIS_LEN
from scitail.settings import WORD_EMBEDDINGS_PATH, WORD_EMBEDDINGS_DIM
from scitail.word_embeddings_loader import WordEmbeddings
...
def predict_batch(test_data, weights_file, verbose=False):
    ...
    for i in range(0, num_tests):
        predicted = y[i]
        res.append(1.0 - np.dot(predicted, [0.0, 1.0]))
