...
from scitail.keras_custom_layers import TimeDistributedHighway, Similarity
from scitail.settings import PREMISE_LEN, HYPOTHESIS_LEN
...
def bidaff(num_words, embeddings_matrix, scope, embedding_dim=64):
    ...
    output = Dense(2, activation='softmax', name="dense_4")(output_3)
