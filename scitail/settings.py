...
TRAIN_DATA_PATH = os.path.join("data", "scitail_1.0_train.txt")
VALIDATE_DATA_PATH = os.path.join("data", "scitail_1.0_dev.txt")
TEST_DATA_PATH = os.path.join("data", "scitail_1.0_test.txt")
